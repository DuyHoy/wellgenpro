...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="http://wellgen.vn/template/frontend/pc/css/contact_style.css">
                           ...
                           <ul class="nav navbar-nav">
                              <div id="menu-inner">
                                 <ul id="menu-top">
                                    ...
                                    <li><a      href="http://wellgen.vn/su-kien-2.html" >Sự kiện</a></li>
                                    <li><a      href="http://wellgen.vn/tin-tuc-2.html" >Tin tức</a></li>
                                    <li><a       href="http://wellgen.vn/lienhe.html"  class="active">Liên hệ</a></li>
                                 </ul>
                              </div>
                           </ul>
                        </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                  <div class="breadcrumbclass" ><a class="homeclass" href="http://wellgen.vn" > Trang chủ</a><b> > </b> <span> Liên hệ</span></div>
                  <h2>Liện hệ</h2>
                  <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                     <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-4 footer-col-1"><img src="/assets/image/media/400x400/logo-png_1442202766.jpg" alt="" width="266" height="82" /></div>
                        <div class="col-lg-10 col-md-8 col-xs-8 col-sm-8 footer-col-3">
                           ...
                           <p>Số điện thoại: 0902 391 886 &amp; 0944 597 059</p>
                     ...
                     <div class="row">
                        <div class='div-contact' >
                           <form method='post' action='' onSubmit = '{return false;};'  class='formcontact' id='formcontact' >
                              ...
                              <p><textarea name="content" class="validate[required] text-input" placeholder="Vui lòng nhập nội dung"></textarea></p>
                        ...
                        <script type="text/javascript" src="http://wellgen.vn/template/backend/default/js/jquery.validationEngine.js"></script> 
                        <script type="text/javascript" >
                           ...
                           document.getElementById('captcha').src="http://wellgen.vn/library/external/captchar/get_captcha.php?rnd=" + Math.random();
                           }
                           
                           $("#formcontact").validationEngine({addFailureCssClassToField: "inputError"}); 
                           jQuery(document).ready(function(){ 
                           	var valid = $("#formcontact").validationEngine();  
                           	$(document).on( 'click', '.submitfrom',  function(event) { 
                           
                           			var valid = $("#formcontact").validationEngine();  
                           
                           	   	    valid = $("#formcontact").validationEngine('validate');  
                           	   	  
                           	   		if (valid == true) {  
                           	   			$.ajax({     
                           			        type: "POST",    
                           
                           			        url: 'http://wellgen.vn/lienhe.html',     
                           			        ...
                           			        data: $("#formcontact").serializeArray(),     
                           			        	...
                           			        	if(msg == 1 ){      
                           			        		...
                           			        		$('.errorclass').html('<span class="success-class">Gửi mail thành công</span>');
                           			        	}
                           			        	else {
                           			        		if ( msg == 3 ) {
                           			        			$('.errorclass').html('<span class="fail-class">Capchar không hợp lệ</span>');
                           			        		}
                           			        		else {
                           			        			$('.errorclass').html('<span class="fail-class">Gửi mail không thành công</span>');
                           			        		} 
                  ...
                  <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                     <div class="row">
                        <h2>Bản đồ</h2>
                        <?  
                           $contentmap = $arrData['getContentFooter']['contentmap_'.$lang];
                  ...
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 footer-col-4">
                           ...
                           <p class='viewpageclass'>Lượt xem trang:<span> <strong><a class="btn btn-primary">1</a><a class="btn btn-primary">4</a><a class="btn btn-primary">0</a><a class="btn btn-primary">1</a><a class="btn btn-primary">3</a><a class="btn btn-primary">3</a></strong></span></p>
                        </div>
                     </div>
                  </div>
               </div>
